import '../kartavozu_screen/widgets/twentynine_item_widget.dart';
...
class KartavozuScreenState extends State<KartavozuScreen> {
  ...
  /// Section Widget
  Widget _buildSkenujQRKD(BuildContext context) {
    return Padding(
  ...
  /// Section Widget
  Widget _buildTwentyFour1(BuildContext context) {
    return GestureDetector(
        onTap: () {
        ...
        child: Consumer<KartavozuProvider>(builder: (context, provider, child) {
          return Wrap(
              ...
              children: List<Widget>.generate(
                  provider.kartavozuModelObj.twentynineItemList.length,
                  (index) {
                TwentynineItemModel model =
                    provider.kartavozuModelObj.twentynineItemList[index];
                return TwentynineItemWidget(model,
