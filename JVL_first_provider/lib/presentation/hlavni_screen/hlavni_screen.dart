import '../hlavni_screen/widgets/twentyone_item_widget.dart';
          ...
          Consumer<HlavniProvider>(builder: (context, provider, child) {
            return Wrap(
                ...
                children: List<Widget>.generate(
                    provider.hlavniModelObj.twentyoneItemList.length, (index) {
                  TwentyoneItemModel model =
                      provider.hlavniModelObj.twentyoneItemList[index];
                  return TwentyoneItemWidget(model,
