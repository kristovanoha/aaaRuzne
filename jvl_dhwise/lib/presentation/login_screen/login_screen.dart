...
class LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
                  ...
                  Expanded(
                      child: SingleChildScrollView(
                          child: Container(
                              ...
                              child: Column(children: [
                                _buildLoginEditText(context),
                                SizedBox(height: 25.v),
                                _buildLoginEditText1(context),
            ...
            bottomNavigationBar: _buildHexxButton1(context)));
  }
  ...
  /// Section Widget
  Widget _buildLoginEditText(BuildContext context) {
    return Selector<LoginProvider, TextEditingController?>(
        selector: (context, provider) => provider.loginEditTextController,
        builder: (context, loginEditTextController, child) {
          return CustomTextFormField(
              controller: loginEditTextController,
  ...
  /// Section Widget
  Widget _buildLoginEditText1(BuildContext context) {
    return Selector<LoginProvider, TextEditingController?>(
        selector: (context, provider) => provider.loginEditTextController1,
        builder: (context, loginEditTextController1, child) {
          return CustomTextFormField(
              controller: loginEditTextController1,
  ...
  /// Section Widget
  Widget _buildHexxButton1(BuildContext context) {
    return CustomElevatedButton(
        height: 51.v,
        text: "lbl_hexx2".tr,
